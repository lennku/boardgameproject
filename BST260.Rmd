...
length(which(game$min_players==0))  #8
which(game$min_players==0)  
...
write.table(game, file = "game_partclean_Shimin.csv", sep = ",", row.names = FALSE,
...
#4) Explore the distribution of our covariates in this dataset
```{r}
